...
Remove the `#` in front of `contentBar` in [line 81](https://github.com/blitionic/blitzionic/blob/main/api/spotify.py#L81) of current master, then the EQ bar will be hidden when you're in not currently playing anything.

## Status String

Have a string saying either "Vibing to:" or "Last seen playing:".

* Change [`height` to `height + 40`](https://github.com/blitionic/blitionic/blob/main/api/templates/spotify.html.j2#L1-L2) (or whatever `margin-top` is set to)
* Uncomment [**.main**'s `margin-top`](https://github.com/blitzionic/blitionic/blob/main/api/templates/spotify.html.j2#L10)
* Uncomment [currentStatus](https://github.com/blitzionic/blitzionic/blob/main/api/templates/spotify.html.j2#L93)
...
&nbsp; <br> [![Spotify](https://blitzionic.vercel.app/api/spotify?background_color=0d1117&border_color=ffffff)]()
